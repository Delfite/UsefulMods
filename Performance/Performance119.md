...
| [Get it Together, Drops!](https://www.curseforge.com/minecraft/mc-mods/get-it-together-drops) | Unknown | Allows the player to configure the range wherein items of the same type merge together. | bl4ckscor3 | Both | None |
